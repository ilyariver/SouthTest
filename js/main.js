...
var whatToCallWrap = document.querySelector('.js-what-to-call-wrap');
var whatToCallInscription = document.querySelector('.js-what-to-call-inscription');
var parallaxWrap = document.querySelector('.js-parallax');
var wrapMiniImg = document.querySelectorAll('.js-wrap-mini-img');
var bigArrowIcon = document.querySelector('.js-wrap-mini-img-arrow');
var proverb = document.querySelectorAll('.js-proverb');
var cookingMethodSection = document.querySelector('.js-cooking-method-section');
var cookingMethod = document.querySelector('.js-cooking-method');
var cookingMethodRotated = document.querySelector('.js-cooking-method-rotated');
var slide = document.querySelectorAll('.js-slide');
var firstUse = true;
parallaxWrap.addEventListener('scroll', function () {
  var currentHeightWindow = parallaxWrap.getBoundingClientRect().height;
  var inscriptionTopLength = Math.round(whatToCallWrap.getBoundingClientRect().top);

  var subtractObjectFromLength = function subtractObjectFromLength() {
    return currentHeightWindow - whatToCallWrap.offsetHeight / 2;
  };

  var cookingMethodTopLength = Math.round(cookingMethodSection.getBoundingClientRect().top);

  var subtractCookingMethodObjectFromLength = function subtractCookingMethodObjectFromLength() {
    return currentHeightWindow - cookingMethodSection.offsetHeight / 2;
  };

  if (inscriptionTopLength < subtractObjectFromLength() && firstUse) {
    setTimeout(function () {
      proverb.forEach(function (word) {
        return word.classList.add('show-text');
      });
    }, 0);
    setTimeout(function () {
      bigArrowIcon.classList.add('show-arrow');

      for (var i = 0; i < wrapMiniImg.length; i++) {
        (function (index) {
          setTimeout(function () {
            wrapMiniImg[index].classList.add('show');
          }, 50 + 100 * index);
        })(i);
      }
    }, 300);
  ...
  if (cookingMethodTopLength < subtractCookingMethodObjectFromLength()) {
    setTimeout(function () {
      for (var i = 0; i < slide.length; i++) {
        (function (index) {
          setTimeout(function () {
            slide[index].classList.add('show-cooking');
          }, 100 + 200 * index);
        })(i);
      }
    }, 0);
...
var headerMenuButton = document.querySelector('.js-header-btn');
var headerContact = document.querySelector('.js-header-contact');
var navigation = document.querySelector('.navigation');
var blockImage = document.querySelector('.js-block-image');
var blockImageTitle = document.querySelector('.section-start__title');
var blockImageText = document.querySelector('.section-start__text');
var smallWidth = 991;

var stateWidthWindow = function stateWidthWindow() {
...
var firstSection = document.querySelector('.section-start');
var secondSection = document.querySelector('.section-what-to-call');
var thirdSection = document.querySelector('.section-what-to-call');
var fourthSection = document.querySelector('.section-what-to-call');
var fifthSection = document.querySelector('.section-what-to-call');
var sixthSection = document.querySelector('.section-what-to-call');
var seventhSection = document.querySelector('.section-what-to-call'); // document.querySelector('html').style.overflow = 'hidden';
...
/***/ "./src/js/components/sliderLib.js":
/*!****************************************!*\
  !*** ./src/js/components/sliderLib.js ***!
  \****************************************/
...
var MySlider = function MySlider(sliderWrap) {
  var sliderArguments = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
  var slider = document.querySelector(sliderWrap);
  var sliderList = slider.children[0];
  var sliderTrack = sliderList.children[0];
  ...
  var slide = function slide() {
    ...
    sliderTrack.style.transform = sliderArguments.vertical ? "translateY(-".concat(slideIndex * slideWidth, "px)") : "translateX(-".concat(slideIndex * slideWidth, "px)");
  };
  ...
  var swipeAction = function swipeAction() {
    ...
    if (isSwipe) {
      ...
      sliderTrack.style.transform = sliderArguments.vertical ? "translateY(".concat(transform - posX2, "px)") : "translateX(".concat(transform - posX2, "px)");
    }
  };
  ...
  var setTransform = function setTransform(transform, comapreTransform) {
    if (transform >= comapreTransform) {
      if (transform > comapreTransform) {
        sliderTrack.style.transform = sliderArguments.vertical ? "translateY(".concat(comapreTransform, "px)") : "translateX(".concat(comapreTransform, "px)");
      }
    }
  ...
  var reachEdge = function reachEdge() {
    transition = false;
    swipeEnd();
    allowSwipe = true;
  };

  sliderTrack.style.transform = sliderArguments.vertical ? "translateY(0)" : "translateX(0)";
  sliderList.classList.add('grab');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _sliderLib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sliderLib */ "./src/js/components/sliderLib.js");

new _sliderLib__WEBPACK_IMPORTED_MODULE_0__["MySlider"]('.js-slider-wrap', {
  vertical: false
});
new _sliderLib__WEBPACK_IMPORTED_MODULE_0__["MySlider"]('.js-recipes-slider-wrap', {
  vertical: true
});
...
var tickerText = document.querySelector('.js-ticker-text');
...
window.onscroll = function (ev) {
  ...
  if (window.pageYOffset < 500) {
    ...
    _span.innerHTML = 'Блюда из гречки&nbsp;';
    tickerText.appendChild(_span);
  }

  tickerText.style.transform = "translateX(-".concat(window.pageYOffset / 2, "px)");
};
...
/* harmony import */ var _components_ticker__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/ticker */ "./src/js/components/ticker.js");
/* harmony import */ var _components_ticker__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_components_ticker__WEBPACK_IMPORTED_MODULE_4__);
...
/* harmony import */ var _components_parallax__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/parallax */ "./src/js/components/parallax.js");
...
/* harmony import */ var _components_animate__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/animate */ "./src/js/components/animate.js");
...
/* harmony import */ var _vendor_ie_fix__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./vendor/ie-fix */ "./src/js/vendor/ie-fix.js");
/* harmony import */ var _vendor_vh_fix__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./vendor/vh-fix */ "./src/js/vendor/vh-fix.js");
/* harmony import */ var _modules_actualYear__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/actualYear */ "./src/js/modules/actualYear.js");
...
Object(_vendor_ie_fix__WEBPACK_IMPORTED_MODULE_8__["ieFix"])();
Object(_vendor_vh_fix__WEBPACK_IMPORTED_MODULE_9__["vhFix"])();
Object(_modules_actualYear__WEBPACK_IMPORTED_MODULE_10__["actualYear"])();
